...
from BPT.get_script_dir import get_script_dir
...
semifinals_quantity = (
    0  # Quantity of semifinals. Every semifinal should be a separate fight!
)
...
npfreject_max = 5  # Maximum number of free tactical rejections (per fight)
...
enable_extra_free_tactical_rejections = False
enable_extra_free_eternal_rejections = False
...
reset_points_before_final = False
...
# TODO: Função do mean - Tirar as notas extremas (caso tenha mais de 5 jurados, etc)
# TODO: Quantos pontos bonus estão dando. 2 pra primeiro, 1 pra segundo, 1.5 pra cada em caso de empate